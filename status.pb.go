...
func (*Status_Host_Info) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 0, 0}
}
...
func (*Status_Host_Temperature) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 0, 1}
}
...
func (*Status_CPU_Info) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 2, 0}
}
...
func (*Status_CPU_Stat) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 2, 1}
}
...
func (*Status_Mem_Virtual) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 3, 0}
}
...
func (*Status_Mem_Swap) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 3, 1}
}
...
func (*Status_Net_Info) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 4, 0}
}
...
func (*Status_Net_Stat) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 4, 1}
}
...
func (*Status_Disk_Info) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 5, 0}
}
...
func (*Status_Disk_Stat) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 5, 1}
}
...
func (*Status_Disk_IO) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfe4fce6682daf5b, []int{0, 5, 2}
}
...
var fileDescriptor_dfe4fce6682daf5b = []byte{
	...
	,
}
...
func (m *Status_Host_Info) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HostId) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.HostId)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.VirtualizationRole) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.VirtualizationRole)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.VirtualizationSystem) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.VirtualizationSystem)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.KernelArch) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.KernelArch)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.KernelVersion) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.KernelVersion)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.PlatformVersion) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.PlatformVersion)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.PlatformFamily) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.PlatformFamily)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Platform) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Platform)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Os) > 0 {
		i -= len(m.Os)
		copy(dAtA[i:], m.Os)
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Os)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Procs != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Procs))
		i--
		dAtA[i] = 0x20
	}
	if m.BootTime != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.BootTime))
		i--
		dAtA[i] = 0x18
	}
	if m.Uptime != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Uptime))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Hostname) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Hostname)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Status_Host_Temperature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SensorKey) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.SensorKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Status_CPU_Info) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Microcode) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Microcode)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.Flags) > 0 {
		for iNdEx := len(m.Flags) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintStatus(dAtA, i, uint64(len(m.Flags[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
	if m.CacheSize != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.CacheSize))
		i--
		dAtA[i] = 0x58
	}
	if m.Mhz != 0 {
	...
	if len(m.ModelName) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.ModelName)))
		i--
		dAtA[i] = 0x4a
	}
	if m.Cores != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Cores))
		i--
		dAtA[i] = 0x40
	}
	if len(m.CoreId) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.CoreId)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.PhysicalId) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.PhysicalId)))
		i--
		dAtA[i] = 0x32
	}
	if m.Stepping != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Stepping))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Model) > 0 {
		i -= len(m.Model)
		copy(dAtA[i:], m.Model)
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Model)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Family) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Family)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.VendorId) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.VendorId)))
		i--
		dAtA[i] = 0x12
	}
	if m.Cpu != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Cpu))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Status_CPU_Stat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Cpu) > 0 {
		i -= len(m.Cpu)
		copy(dAtA[i:], m.Cpu)
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Cpu)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Status_Mem_Virtual) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Free != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Free))
		i--
		dAtA[i] = 0x28
	}
	if m.UsedPercent != 0 {
	...
	if m.Used != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Used))
		i--
		dAtA[i] = 0x18
	}
	if m.Available != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Available))
		i--
		dAtA[i] = 0x10
	}
	if m.Total != 0 {
...
func (m *Status_Mem_Swap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.PgFault != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.PgFault))
		i--
		dAtA[i] = 0x48
	}
	if m.PgOut != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.PgOut))
		i--
		dAtA[i] = 0x40
	}
	if m.PgIn != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.PgIn))
		i--
		dAtA[i] = 0x38
	}
	if m.Sout != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Sout))
		i--
		dAtA[i] = 0x30
	}
	if m.Sin != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Sin))
		i--
		dAtA[i] = 0x28
	}
	if m.UsedPercent != 0 {
...
func (m *Status_Net_Info) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AddrList) > 0 {
		for iNdEx := len(m.AddrList) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintStatus(dAtA, i, uint64(len(m.AddrList[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
	...
	if len(m.HardwareAddr) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.HardwareAddr)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Name) > 0 {
	...
	if m.Mtu != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Mtu))
		i--
		dAtA[i] = 0x10
	}
	if m.Index != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Status_Net_Stat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Fifoout != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Fifoout))
		i--
		dAtA[i] = 0x58
	}
	if m.Fifoin != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Fifoin))
		i--
		dAtA[i] = 0x50
	}
	if m.Dropout != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Dropout))
		i--
		dAtA[i] = 0x48
	}
	if m.Dropin != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Dropin))
		i--
		dAtA[i] = 0x40
	}
	if m.Errout != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Errout))
		i--
		dAtA[i] = 0x38
	}
	if m.Errin != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.Errin))
		i--
		dAtA[i] = 0x30
	}
	if m.PacketsRecv != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.PacketsRecv))
		i--
		dAtA[i] = 0x28
	}
	if m.PacketsSent != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.PacketsSent))
		i--
		dAtA[i] = 0x20
	}
	if m.BytesRecv != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.BytesRecv))
		i--
		dAtA[i] = 0x18
	}
	if m.BytesSent != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.BytesSent))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Name) > 0 {
...
func (m *Status_Disk_Info) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Fstype) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Fstype)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Mountpoint) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Mountpoint)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Device) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Device)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Status_Disk_Stat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.InodesFree != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.InodesFree))
		i--
		dAtA[i] = 0x48
	}
	if m.InodesUsed != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.InodesUsed))
		i--
		dAtA[i] = 0x40
	}
	if m.InodesTotal != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.InodesTotal))
		i--
		dAtA[i] = 0x38
	}
	if m.UsedPercent != 0 {
	...
	if len(m.Path) > 0 {
		i -= len(m.Path)
		copy(dAtA[i:], m.Path)
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Path)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Status_Disk_IO) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Label) > 0 {
		i -= len(m.Label)
		copy(dAtA[i:], m.Label)
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Label)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.SerialNumber) > 0 {
		...
		i = encodeVarintStatus(dAtA, i, uint64(len(m.SerialNumber)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.Name) > 0 {
	...
	if m.WeightedIO != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.WeightedIO))
		i--
		dAtA[i] = 0x58
	}
	if m.IoTime != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.IoTime))
		i--
		dAtA[i] = 0x50
	}
	if m.IopsInProgress != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.IopsInProgress))
		i--
		dAtA[i] = 0x48
	}
	if m.WriteTime != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.WriteTime))
		i--
		dAtA[i] = 0x40
	}
	if m.ReadTime != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.ReadTime))
		i--
		dAtA[i] = 0x38
	}
	if m.WriteBytes != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.WriteBytes))
		i--
		dAtA[i] = 0x30
	}
	if m.ReadBytes != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.ReadBytes))
		i--
		dAtA[i] = 0x28
	}
	if m.MergedWriteCount != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.MergedWriteCount))
		i--
		dAtA[i] = 0x20
	}
	if m.WriteCount != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.WriteCount))
		i--
		dAtA[i] = 0x18
	}
	if m.MergedReadCount != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.MergedReadCount))
		i--
		dAtA[i] = 0x10
	}
	if m.ReadCount != 0 {
		i = encodeVarintStatus(dAtA, i, uint64(m.ReadCount))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Status_Host_Info) Size() (n int) {
	...
	if m.Uptime != 0 {
		n += 1 + sovStatus(uint64(m.Uptime))
	}
	if m.BootTime != 0 {
		n += 1 + sovStatus(uint64(m.BootTime))
	}
	if m.Procs != 0 {
		n += 1 + sovStatus(uint64(m.Procs))
	}
	l = len(m.Os)
	if l > 0 {
		n += 1 + l + sovStatus(uint64(l))
...
func (m *Status_CPU_Info) Size() (n int) {
	...
	if m.Stepping != 0 {
		n += 1 + sovStatus(uint64(m.Stepping))
	}
	l = len(m.PhysicalId)
	if l > 0 {
		n += 1 + l + sovStatus(uint64(l))
	...
	if m.CacheSize != 0 {
		n += 1 + sovStatus(uint64(m.CacheSize))
	}
	if len(m.Flags) > 0 {
...
func (m *Status_Mem_Virtual) Size() (n int) {
	...
	if m.Available != 0 {
		n += 1 + sovStatus(uint64(m.Available))
	}
	if m.Used != 0 {
		n += 1 + sovStatus(uint64(m.Used))
	}
	if m.UsedPercent != 0 {
		n += 9
	}
	if m.Free != 0 {
		n += 1 + sovStatus(uint64(m.Free))
	}
	return n
}
...
func (m *Status_Mem_Swap) Size() (n int) {
	...
	if m.Sin != 0 {
		n += 1 + sovStatus(uint64(m.Sin))
	}
	if m.Sout != 0 {
		n += 1 + sovStatus(uint64(m.Sout))
	}
	if m.PgIn != 0 {
		n += 1 + sovStatus(uint64(m.PgIn))
	}
	if m.PgOut != 0 {
		n += 1 + sovStatus(uint64(m.PgOut))
	}
	if m.PgFault != 0 {
		n += 1 + sovStatus(uint64(m.PgFault))
	}
	return n
}
...
func (m *Status_Net_Info) Size() (n int) {
	...
	_ = l
	if m.Index != 0 {
		n += 1 + sovStatus(uint64(m.Index))
	}
	if m.Mtu != 0 {
		n += 1 + sovStatus(uint64(m.Mtu))
	}
	l = len(m.Name)
	if l > 0 {
		n += 1 + l + sovStatus(uint64(l))
...
func (m *Status_Net_Stat) Size() (n int) {
	...
	if m.BytesSent != 0 {
		n += 1 + sovStatus(uint64(m.BytesSent))
	}
	if m.BytesRecv != 0 {
		n += 1 + sovStatus(uint64(m.BytesRecv))
	}
	if m.PacketsSent != 0 {
		n += 1 + sovStatus(uint64(m.PacketsSent))
	}
	if m.PacketsRecv != 0 {
		n += 1 + sovStatus(uint64(m.PacketsRecv))
	}
	if m.Errin != 0 {
		n += 1 + sovStatus(uint64(m.Errin))
	}
	if m.Errout != 0 {
		n += 1 + sovStatus(uint64(m.Errout))
	}
	if m.Dropin != 0 {
		n += 1 + sovStatus(uint64(m.Dropin))
	}
	if m.Dropout != 0 {
		n += 1 + sovStatus(uint64(m.Dropout))
	}
	if m.Fifoin != 0 {
		n += 1 + sovStatus(uint64(m.Fifoin))
	}
	if m.Fifoout != 0 {
		n += 1 + sovStatus(uint64(m.Fifoout))
	}
	return n
}
...
func (m *Status_Disk_Stat) Size() (n int) {
	...
	if m.InodesTotal != 0 {
		n += 1 + sovStatus(uint64(m.InodesTotal))
	}
	if m.InodesUsed != 0 {
		n += 1 + sovStatus(uint64(m.InodesUsed))
	}
	if m.InodesFree != 0 {
		n += 1 + sovStatus(uint64(m.InodesFree))
	}
	if m.InodesUsedPercent != 0 {
		n += 9
	}
...
func (m *Status_Disk_IO) Size() (n int) {
	...
	_ = l
	if m.ReadCount != 0 {
		n += 1 + sovStatus(uint64(m.ReadCount))
	}
	if m.MergedReadCount != 0 {
		n += 1 + sovStatus(uint64(m.MergedReadCount))
	}
	if m.WriteCount != 0 {
		n += 1 + sovStatus(uint64(m.WriteCount))
	}
	if m.MergedWriteCount != 0 {
		n += 1 + sovStatus(uint64(m.MergedWriteCount))
	}
	if m.ReadBytes != 0 {
		n += 1 + sovStatus(uint64(m.ReadBytes))
	}
	if m.WriteBytes != 0 {
		n += 1 + sovStatus(uint64(m.WriteBytes))
	}
	if m.ReadTime != 0 {
		n += 1 + sovStatus(uint64(m.ReadTime))
	}
	if m.WriteTime != 0 {
		n += 1 + sovStatus(uint64(m.WriteTime))
	}
	if m.IopsInProgress != 0 {
		n += 1 + sovStatus(uint64(m.IopsInProgress))
	}
	if m.IoTime != 0 {
		n += 1 + sovStatus(uint64(m.IoTime))
	}
	if m.WeightedIO != 0 {
		n += 1 + sovStatus(uint64(m.WeightedIO))
	}
	l = len(m.Name)
	if l > 0 {
		n += 1 + l + sovStatus(uint64(l))
